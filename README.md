...
This package can be used to calculate three R2s for regression models with the following class: 'lmerMod' (LMM), 'glmerMod' (GLMM), 'phylolm' (Phylogenetic GLS), and 'binaryPGLMM' (Phylogenetic logistic regression). Detailed technical descriptions can be found in [this Ives 2017 preprint](http://www.biorxiv.org/content/early/2017/05/30/144170).
...
| LMM               | R2.ce, R2.ls, R2.lr     |
| GLMM              | R2.ce, R2.ls, R2.lr     |
| PGLS              | R2.ce, R2.ls, R2.lr     |
