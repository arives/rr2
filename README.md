...
devtools::install_github("arives/rr2", ref = "cpp_ce")
# for macOS, you can also install the binary file
install.packages("https://raw.githubusercontent.com/arives/rr2/cpp_ce/rr2_0.1.0.tgz", repos = NULL)
library(rr2)
```
...
Time comparsions of cpp
=======================

``` r
microbenchmark::microbenchmark(R2.pred(mod = z.f.pgls, mod.r = z.v.pgls, phy = phy, cpp = T),
                               R2.pred(mod = z.f.pgls, mod.r = z.v.pgls, phy = phy, cpp = F),
                               times = 50)
```

    ## Unit: milliseconds
    ##                                                           expr       min
    ##  R2.pred(mod = z.f.pgls, mod.r = z.v.pgls, phy = phy, cpp = T)  35.14114
    ##  R2.pred(mod = z.f.pgls, mod.r = z.v.pgls, phy = phy, cpp = F) 100.99621
    ##        lq      mean    median        uq       max neval cld
    ##   36.3447  37.63903  37.43215  38.74612  41.82523    50  a 
    ##  104.1351 110.15594 107.09079 109.88222 227.55160    50   b
